...
namespace Assets.HeroEditor4D.Common.CharacterScripts
{
    ...
    {
        public static Character4D instance;
        ...
        public override void Initialize() => Parts.ForEach(i => i.Initialize());
        ...
        public override string ToJson() => Front.ToJson();

        public override void FromJson(string json, bool silent) => Parts.ForEach(i => i.LoadFromJson(json, silent));
		...
		public void SetDirection(Vector2 direction)
		{
			...
			if (direction == Vector2.left) index = 2;
			
			else if (direction == Vector2.right) index = 3;
			
			else if (direction == Vector2.up) index = 1;
			
			else if (direction == Vector2.down) index = 0;
