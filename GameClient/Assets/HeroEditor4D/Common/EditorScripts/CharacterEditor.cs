  ...
  //          }));
	 //   }
        ...
        public void Paint(Color color)
        {
            ...
            {
                part.color = color;
                part.sharedMaterial = color == Color.black ? DefaultMaterial : ActiveTab.name == "Eyes" ? EyesPaintMaterial : EquipmentPaintMaterial;
            }
        ...
        protected override void FeedbackTip()
	    {
		 ...
		 //   var success = UnityEditor.EditorUtility.DisplayDialog("HeroView Editor","Hello", "Review", "Later");
